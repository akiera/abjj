...
<body>
  ...
  <td width="640"  bkground="../../smi_system/pic/inventory2.gif" style="bkground-repeat:no-repeat; bkground-position:center " ></br>
<table width="580" align="center" border="0">
		...
		<tr><td align="right"></br><form name="searchitem" method="post" tion="">
						<input name="txtsearchkey" type="text" size="30" class="style31" alt="keyword search" onfocus="this.style.bkgroundColor='#333333'; this.style.color='white'"
  							onblur="this.style.bkgroundColor='white'; this.style.color='blk'">
                        <input name="search" id="search" type="Submit" value="Search" onClick="return searching()"></form>
						</br>
		</td></tr>
		</table>
		...
		<tr class="style7">
		  <td width="6%" align="center" bgcolor="#3399FF">No.</td>
			<td width="34%" align="center" bgcolor="#3366CC">Supplier</td>
			<td width="13%" align="center" bgcolor="#3399FF">Date</td>
		  <td width="22%" align="center" bgcolor="#3366CC">No. Invoice</td>
			<td width="13%" align="center" bgcolor="#3399FF">Amaun</td>
		  <td width="12%" align="center" bgcolor="#3366CC">Update Status</td>
		</tr>
		...
		<?php
			if (isset($_POST['txtsearchkey']))
			{
				...
				?>
                              <tr bgcolor="#FFFFFF" class="style9" onMouseOver="this.bgColor='#D3FCAB'" onMouseOut="this.bgColor='#FFFFFF'">
                                <td><div align="center"><? echo $x; ?></div></td>
                                <td><div align="center"><? echo $row["pembekal"]; ?></div></td>
                                <td ><div align="left"><? echo $row["tarikh"]; ?></div></td>
				...
				if ($x<1)
				{
					...
					print "window.location='../data/item.php'";
					print "</script> ";
				}			
				}
				else
				{
								...
								$query2=" SELECT * FROM t_purchase";
								$result2=mysql_query($query2);
								echo mysql_error();
								$nume=mysql_num_rows($result2);

						
						$sql = "SELECT * FROM t_purchase ORDER BY pembekal LIMIT $eu, $limit";
						$result = mysql_query($sql) or die ('Data of search cannot be rehed. ' . mysql_error());
						$x=0;
