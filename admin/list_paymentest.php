...
$sql = "Select * from t_payment where month(tarikh) = $month and tahun(tarikh) = $tahun and cawangan = '$cawangan'";
...
<body>
                ...
                <p class="style1">&nbsp;</p>
                <p class="style1">&nbsp;</p>
<p align="center" class="style3 style17"><strong>PAYMENT LIST</strong></p>
<table width="450" border="0" align="center" cellpadding="0" cellspacing="0" >

              
              
<form name="searchShop" method="post" action="?p=view_list_payment" target="">
