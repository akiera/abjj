...
$result1 = mysql_query($query1) or die ('Data Topup Transferccannot be reached.' . mysql_error());
...
<body> 
    <div id="content">
<h3><span class="style1">VIEW</span> <span class="style1">TOPUP TRANSFER</span></h3>
                    ...
                    <li>
                      <div class="form_grid_12">
                        ...
                        <div class="form_input">
                         ...
                         <input name="dateTopup" type="text" disabled="disabled" maxlength="255" value="<? echo $record1["tarikh"]; ?>" size="20" />
                          </div>
