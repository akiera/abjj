...
$sql = "Select * from t_purchase where month(date) = $month and tahun(date) = $tahun and cawangan = '$cawangan'";
...
<body>
                ...
                <p class="style1">&nbsp;</p>
                <p class="style1">&nbsp;</p>
<p align="center" class="style17 style3"><strong>PURCHASE LIST</strong></p>
<p align="center" class="style17 style3">&nbsp;</p>
<table width="450" border="0" align="center" cellpadding="0" cellspacing="0" >

              
              
<form name="searchShop" method="post" action="?p=view_list_purchase">
