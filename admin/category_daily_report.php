...
<div id="content">
		<div class="grid_container">
					<div class="widget_content">
						<div id="tab1">
							<h3 align="center">SUMMARY OF DAILY REPORT</h3>
					  <form name="searchShop" action="summary_daily_report.php" target="_blank" method="post" class="form_container left_label">
                                      							<ul>
                ...
                <li>
                              ...
                              <select name="tahun" id="tahun" class="chzn-select" style=" width:200px" data-placeholder="Please Select Year">
								...
								<ul>
									...
									<div class="form_grid_12">
										<div class="form_input">
											<button type="submit" class="btn_small btn_blue"><span>View Report</span></button>
										</div>
									</div>
									</li>
								</ul>
