...
<body>
                ...
                <p class="style1">&nbsp;</p>
                <p class="style1">&nbsp;</p>
<p align="center" class="style17 style3"><strong>LIST DAILY REPORT</strong> <strong>FOR EMART, ETECHNO &amp; EDAMAN ONLY</strong></p>
<p align="center" class="style17 style3">&nbsp;</p>
<table width="450" border="0" align="center" cellpadding="0" cellspacing="0" >

              
              
<form name="searchShop" method="post" action="?p=new_view_list_daily_report">
  ...
  <td width="180" class="style18 style10"><span class="style24"></span></td>
                      ...
                      <td align="center" colspan="3" class="style16">
                        <p><br />
                          <input type="image" src="../images/viewlist.png" name="search" value="Search" />
                        </p>
                        <p>&nbsp;</p>
                        <p>&nbsp;</p>
                        <p>&nbsp;</p>
