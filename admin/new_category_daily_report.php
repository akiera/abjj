...
$sql = "Select * from t_dailyReport where month(date) = $month and tahun(date) = $tahun and cawangan = '$cawangan'";
...
<body>
                ...
                <p class="style1">&nbsp;</p>
                <p class="style1">&nbsp;</p>
<p align="center" class="style3 style17"><strong>SUMMARY OF DAILY  REPORT </strong><strong>FOR EMART, ETECHNO &amp; EDAMAN ONLY</strong></p>
<p align="center" class="style3 style17">&nbsp;</p>
<table width="450" border="0" align="center" cellpadding="0" cellspacing="0" >

              
              
<form name="searchShop" method="post" action="new_summary_daily_report.php" target="_blank">
  ...
  <td width="180" class="style18 style10"><span class="style24"></span></td>
                      ...
                      <td align="center" colspan="3" class="style16">
                        <p><br />
                          <input type="image" src="../images/viewreport.png" name="search" value="Search" />
                        </p>
                        <p>&nbsp;</p>
                        <p>&nbsp;</p>
                        <p>&nbsp;</p>
