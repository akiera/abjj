...
<h3><span class="style3">EDIT</span> <span class="style3">PAYMENT</span></h3>
<form action="?p=save_edit_payment" method="post" class="form_container left_label">	
                      							
<ul>
										<li>
										<div class="form_grid_12">
											<label class="field_title">ID PAYMENT</label>
											<label class="description" for="element_1"><span class="style18">&nbsp; PY0<span class="style15"><? echo $record["idPayment"]; ?></span></span></label>
										</div>
										</li>
            <li>
                                          <div class="form_grid_12">
             ...
             <li>
                                          <div class="form_grid_12">
                                            <label class="field_title">SUPPLIER</label><div class="form_input">
                                              <select name="pembekal" multiple class="chzn-select" style=" width:200px;" tabindex="14">
