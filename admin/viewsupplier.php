...
<form action="?p=edit_Supplier" method="post" class="form_container left_label">
                  <ul>
                    <li>
  ...
  <ul>
    <li> <input type="hidden" name="idpembekal" value="<? echo $record["idPembekal"]; ?>">
      <div class="form_grid_12">
          <div class="form_input">
            <a href='?p=edit_Supplier&idPembekal=<? echo base64_encode($record["idPembekal"]); ?>'>          
