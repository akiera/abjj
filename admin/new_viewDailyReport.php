...
-->
    ...
    <body>
                ...
                <h2 class="style12">&nbsp;</h2>
                <form action="?p=new_edit_daily_report" method="post" id="form1">
                  <table width="417" align="center" cellpadding="0" cellspacing="0" style="border:none">
                    <!--DWLayoutTable-->
                    <tr>
                      <td colspan="3" bgcolor="#9900FF"><div align="center" class="style1" style="height:30px; vertical-align:middle; ">View Daily Report </div></td>
                    </tr>
                    <tr>
                    ...
                    <tr bordercolor="#FFFFFF">
                     ...
                     <tr>
                     <tr>
                      <td height="25" bgcolor="#F2F0DC"><strong>Cash</strong></td>
                     
                      <td bgcolor="#F2F0DC"><span class="style15">:<strong> RM
                        <? $cash=$record1["sales"]-$total;			
			   				echo number_format($cash,2, ".", ",");
						?>
                      </strong></span></td>
                    </tr>
                      <td height="25" bgcolor="#F2F0DC">B/F</td>
                     
                      <td bgcolor="#F2F0DC"><span class="style15">: RM <? echo number_format($record1["bf"],2,".",","); ?></span></td>
                    </tr>
                     <tr bordercolor="#FFFFFF">
                      ...
                      <td width="258" bgcolor="#F2F0DC"><span class="style15">: RM <? echo number_format($record1["advance"],2,".",","); ?></span></td>
                                        ...
                                        <tr bordercolor="#FFFFFF">
                      <td height="25" bgcolor="#F2F0DC">Cash Transfer</td>
                     
                      <td bgcolor="#F2F0DC"><span class="style15">: RM
                          <? echo number_format($record1["cashTransfer"],2,".",","); ?></span></td>
                    </tr>
                  ...
                  <table align="center">
                    <tr>
                      <td width="80" height="30" align="center"><input type="hidden" name="id_product" value="<? echo $record1["id_product"]; ?>" />
                          <input type="image" name="productSubmit" value="Edit" onClick="return submit_product()" src="../images/edit.png"/>
                      </td>
                      <td width="80"><input type="hidden" name="idDailyReport" value="<? echo $record1["idDailyReport"]; ?>" />
                      <a href='new_delete_daily_report.php?idDailyReport=<? echo $record1["idDailyReport"]; ?>' onClick="return confirm_del()"><img src="../images/delete.png"></a></td>
                    </tr>
                  </table>
