...
<form id="form1" method="post" action="#">
		<table width="688" align="center" border="1">
		<tr class="style7">
		  ...
		  <td width="7%" rowspan="2" align="center" bgcolor="#CC00FF"><strong>Sales</strong></td>
	  	  <td height="32" colspan="4" align="center" bgcolor="#CC00FF"><strong>Cash Expenses (RM)</strong><strong></strong></td>
		  <td width="12%" rowspan="2" align="center" bgcolor="#CC00FF"><strong>Advance Claims (RM)</strong><strong></strong></td>
	  	  <td width="13%" rowspan="2" align="center" bgcolor="#CC00FF"><strong>Cash Transfer(RM)</strong><strong></strong></td>
		  <td width="9%" rowspan="2" align="center" bgcolor="#CC00FF"><strong>Cash Bank In (RM)</strong><strong></strong></td>
	  	  <td width="9%" rowspan="2" align="center" bgcolor="#CC00FF"><strong>Edit</strong><strong></strong></td>
		</tr>
        <tr class="style7">
	  	  <td width="10%" height="20" align="center" bgcolor="#CC00FF"><strong>Purchase</strong></td>
		  <td width="8%" align="center" bgcolor="#CC00FF"><strong>Salary</strong></td>
	  	  <td width="8%" align="center" bgcolor="#CC00FF"><strong>Others</strong></td>
          <td width="9%" align="center" bgcolor="#CC00FF"><strong>Total</strong></td>
		  </tr>
<?php 
		...
		{	
	 	?>
                              ...
                              <tr bgcolor="#99FFFF" class="style9" onMouseOver="this.bgColor='#D3FCAB'" onMouseOut="this.bgColor='#99FFFF'">
                                ...
                                <td><div align="left"><? echo $record["date"]; ?></div></td>
						...
						?>
								...
								<td bgcolor="#99CCFF"><div align="center"><strong><? echo number_format($allCashTransfer,2, ".", ",");?></strong></div></td>
    ...
    <tr> 
                <td align="center"> 
				  <div align="center"><a href="?p=new_daily_report" target="_self"><img src="../images/add_new.png" alt="Add" border="0"></a><b>
