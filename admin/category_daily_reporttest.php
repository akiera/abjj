...
<body>
                ...
                <p class="style1">&nbsp;</p>
                <p class="style1">&nbsp;</p>
<p align="center" class="style3 style17"><strong>SUMMARY OF DAILY  REPORT</strong> <strong>FOR NND &amp; EZAN ONLY</strong></p>
<p align="center" class="style3 style17">&nbsp;</p>
<table width="450" border="0" align="center" cellpadding="0" cellspacing="0" >

              
              
<form name="searchShop" method="post" action="summary_daily_report.php" target="_blank">
