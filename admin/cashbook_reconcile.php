...
$sql = "Select * from t_cashbook where month2(date) = $month2 and tahun(date) = $tahun and cawangan = '$cawangan'";
...
<div id="content">
		<div class="grid_container">
					<div class="widget_content">
						<div id="tab1">
							<h3 align="center">CASH BOOK RECONCILE</h3>
					  <form name="searchShop" action="cashbook_reconcile_report.php" target="_blank" method="post" class="form_container left_label">                      							
<ul>
