...
<form id="form1" method="post" action="?p=edit_payment_status">
		<table width="688" align="center" border="1">
		<tr class="style7">
		  <td width="6%" align="center" bgcolor="#CC00FF"><strong>No.</strong></td>
			<td width="42%" align="center" bgcolor="#CC00FF"><strong>Supplier</strong></td>
		  <td width="15%" align="center" bgcolor="#CC00FF"><strong>Date</strong></td>
		  <td width="15%" align="center" bgcolor="#CC00FF"><strong>No. Invoice</strong></td>
			<td width="11%" align="center" bgcolor="#CC00FF"><strong>Amaun</strong></td>
		  <td width="11%" align="center" bgcolor="#CC00FF"><strong>Status</strong></td>
		</tr>
