...
$sql = "Select * from t_purchase where month(tarikh) = '$month2' and tahun(tarikh) = '$tahun' and cawangan = '$cawangan'";
...
<div id="content">
		<div class="grid_container">
					<div class="widget_content">
						<div id="tab1">
							<h3 align="center">CHECK PAYMENT STATUS</h3>
					  <form name="searchShop" action="?p=choose_supplier" method="post" class="form_container left_label">                      							
<ul>
