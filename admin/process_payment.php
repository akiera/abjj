...
$query = "UPDATE t_purchase SET status='$txtStatus' WHERE idPurchase='$idPurchase'";
...
$query = "INSERT INTO t_payment (idPayment, cawangan, pembekal, tarikh, chqNo, amaunt, cn, oleh, time, date2) 
			VALUES ('$txtPaymentId', '$txtcawangan', '$txtpembekal', '$finddate', '$txtChq', '$txtTotal', '$txtCn', '$prepared', '$time', '$txtdate')";
