...
$result = mysql_query($sql) or die ('Data of daily report cannot be access. ' . mysql_error());
...
$query = "INSERT INTO t_dailyReport (idDailyReport, cawangan, date, sales, purchase, salary, others, advance, cashTransfer, cashBankIn, oleh, time, date2) 
			VALUES ('$txtdailyReportId', '$txtcawangan', '$finddate', '$txtSales', '$txtPur',  '$txtSal', '$txtOth', '$txtAdv', '$txtTra', '$txtBan', '$prepared', '$time', '$txtdate')";
