...
<h3><span class="style1">TOPUP TRANSFER</span></h3>
		<form action="process_topup_transfer.php" method="post" class="form_container left_label">	
										...
										<div class="form_grid_12">
											...
											<div class="form_input">
												<div class=" form_grid_2 alpha">
												  <input id="txtDate" name="dateTopup" class="datepicker"  type="text" maxlength="255" value="" size="20" />
												</div>
