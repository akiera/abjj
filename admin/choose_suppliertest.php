...
<form id="form1" method="post" action="testUpdatePaidReport.php">
		...
		<tr class="style7">
		  <td width="5%" align="center" bgcolor="#CC00FF"><strong>No.</strong></td>
			<td width="35%" align="center" bgcolor="#CC00FF"><strong>Supplier</strong></td>
			<td width="11%" align="center" bgcolor="#CC00FF"><strong>Date</strong></td>
		  <td width="14%" align="center" bgcolor="#CC00FF"><strong>No. Invoice</strong></td>
			<td width="13%" align="center" bgcolor="#CC00FF"><strong>Amount </strong>(RM)</td>
		  <td width="13%" align="center" bgcolor="#CC00FF"><strong> Status</strong></td>
          <td width="9%" align="center" bgcolor="#CC00FF"><strong>Payment</strong></td>
		</tr>
			...
			if (isset($_POST['txtsearchkey']))
			{
				...
				?>
                              <tr bgcolor="#99FFFF" class="style9" onMouseOver="this.bgColor='#D3FCAB'" onMouseOut="this.bgColor='#99FFFF'">
                                <td><div align="center"><? echo $x; ?><input type="hidden" name="reportId" value="<?php echo $row['id'] ?></div></td>
                                <td><div align="left">
                                </div></td>
                                ...
                                <td><div align="right"><? echo $row["amaun"]; ?></div></td>
                                <td><div align="center"><? echo $row["status"]; ?></div></td>
                                <td><div align="center">
                                  <label>
                                  <input type="checkbox" name="checkbox" id="checkbox" value="Paid">
                                  </label>
                                 </div>                                 </td>
                              </tr>
                              <? }?>
