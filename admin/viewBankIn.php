...
<body> 
    <div id="content">
<h3><span class="style1">VIEW</span> <span class="style1">BANK IN RECORD</span></h3>
                <form action="?p=edit_bankin" method="post" class="form_container left_label">
                  <ul>
                    <li>
                  ...
                  <ul>
                    <li>
                      ...
                      <div class="form_grid_12">
                        <div class="form_input">
                        <a href='?p=edit_bankin&idCash=<? echo base64_encode($record1["idCash"]); ?>'>
