...
<h3><span class="style3">EDIT BOS ADVANCE</span></h3>
<form action="save_edit_bosadv.php" method="post" class="form_container left_label">	
            ...
            <li>
					  ...
					  <span class="clear"></span>
										  ...
										  <div class="form_grid_12">
                                            ...
                                            <div class="form_input">
                           <input name="masuk" type="text" value="<? echo $record["keluar"]; ?>" maxlength="255" class="small"/>
                                            </div>
									      </div>
			</li>
  </ul>									
