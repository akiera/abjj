...
$sql = "Select * from t_topup where month2(date) = $month2 and tahun(date) = $tahun and cawangan = '$cawangan'";
...
<div id="content">
		<div class="grid_container">
					<div class="widget_content">
						<div id="tab1">
							<h3 align="center">TOPUP BOOK LIST</h3>
					  <form name="searchShop" action="?p=view_list_topupbook" method="post" class="form_container left_label">                      							
<ul>
