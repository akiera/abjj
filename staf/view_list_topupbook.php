...
<form id="form1" method="post" action="">
    <tr>
        <td width="640" bkground="" style="bkground-repeat:no-repeat; bkground-position:center ">
            ...
            <p align="center"><span class="style2"><strong>TOPUP TRANSFER BOOK LIST
                        FOR</strong> <strong><?php echo $bulan1; ?>
                        &nbsp;<? echo $tahun = $_POST['tahun']; ?></strong></span></p>
            <table class="display" id="data_tbl_tools">
                ...
                $sql = "SELECT * FROM t_topup WHERE cawangan='$cawangan' and month(tarikh) = $month2 and year(tarikh) = $tahun ORDER BY tarikh";
                ...
                while ($record = mysql_fetch_array($result)) {
                    ...
                    <tr class="">
                        ...
                        <td bgcolor="#99FFFF">
                            <div align="center"><a href='?p=viewtopupbook&idTopup=<? echo $record["idTopup"]; ?>'
                                                   class="style27">Detail</a></div>
                        </td>
                    </tr>
                    <?
                    $i++;
