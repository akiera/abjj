...
$result = mysql_query($query) or die ('Data Bank In Topup cannot be reached.' . mysql_error());
...
<h3><span class="style3">EDIT BANK IN TOPUP</span></h3>
<form action="save_edit_bankin_topup.php" method="post" class="form_container left_label">	
