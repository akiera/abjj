...
?>
  ...
  <table class="display" id="data_tbl_tools2">
    <thead>
      <tr>
        <th width="47"> No. </th>
        <th width="271"> Particulars</th>
...
<tr>
  <td width="640"  bkground="" style="bkground-repeat:no-repeat; bkground-position:center " >
    <p align="center" class="style1">CASH TRANSFER</p>
    <table class="display" id="data_tbl_tools">
      <thead>
        <tr>
          <th width="47"> No. </th>
       ...
       <?php 
		...
		$sql = "SELECT * FROM t_cashbook WHERE cawangan='$cawangan' and month(tarikh) = $month2 and year(tarikh) = $tahun and butir != 'CASH TRANSFER' and butir != 'BANK IN' and butir != 'B/F' ORDER BY tarikh";
		$result = mysql_query($sql) or die ('Data Cash Book cannot be reach. ' . mysql_error());
