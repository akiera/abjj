...
$result20 = mysql_query($query20) or die ('Data Cash transfer cannot be reached.' . mysql_error());
...
<h3><span class="style1">CASH TRANSFER</span></h3>
		<form action="process_cashtransfer.php" method="post" class="form_container left_label">	
                      							
<ul>
										<li>
										<div class="form_grid_12">
											<label class="field_title">ID CASH TRANSFER</label>
