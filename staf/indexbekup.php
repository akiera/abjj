	...
	<div id="sidebar">
		<div id="secondary_nav">
			<ul id="sidenav" class="accordion_mnu collapsible">
			  ...
			  <li><a href="?p=snarai_pembekal"><span class="nav_icon frames"></span> Supplier</span><span class="">&nbsp;</span></a>
<ul class="acitem">
					<li><a href="../admin/?p=staff_list"><span class="list-icon">&nbsp;</span>Staff</a></li>
					<li><a href="../admin/?p=snarai_cawangan"><span class="list-icon">&nbsp;</span>Minimart</a></li>
					<li><a href="../admin/?p=snarai_pembekal"><span class="list-icon">&nbsp;</span>Supplier</a></li>
				</ul>
				</li>
				<li><a href="#"><span class="nav_icon documents"></span>Purchase</span><span class="up_down_arrow">&nbsp;</span></a>
				<ul class="acitem">
					<li><a href="../admin/?p=purchase"><span class="list-icon">&nbsp;</span>New Purchase</a></li>
					<li><a href="../admin/?p=list_purchase"><span class="list-icon">&nbsp;</span>Purchase List</a></li>
                </ul>
				</li>
				<li><a href="#"><span class="nav_icon frames"></span>Payment</span><span class="up_down_arrow">&nbsp;</span></a>
				<ul class="acitem">
					<li><a href="../admin/?p=new_payment"><span class="list-icon">&nbsp;</span>New Payment</a></li>
   					<li><a href="../admin/?p=list_payment"><span class="list-icon">&nbsp;</span>Payment List</a></li>
				</ul>
				</li>
                <li><a href="#"><span class="nav_icon frames"></span>Daily Report</span><span class="up_down_arrow">&nbsp;</span></a>
				<ul class="acitem">
					<li><a href="../admin/?p=daily_report"><span class="list-icon">&nbsp;</span>New Daily Report</a></li>
					<li><a href="../admin/?p=list_daily_report"><span class="list-icon">&nbsp;</span>Daily Report List</a></li>
				</ul>
				</li>
				<li><a href="#"><span class="nav_icon bulls_eye"></span>Manager Page</span><span class="up_down_arrow">&nbsp;</span></a>
				<ul class="acitem">
					<li><a href="../admin/?p=bank_in"><span class="list-icon">&nbsp;</span>Bank In</a></li>
					<li><a href="../admin/?p=list_bankin"><span class="list-icon">&nbsp;</span>Bank In List</a></li>
					<li><a href="../admin/?p=cash_book"><span class="list-icon">&nbsp;</span>Cash Book</a></li>								<li><a href="../admin/?p=list_cashbook"><span class="list-icon">&nbsp;</span>Cash Book List</a></li>
					<li><a href="../admin/?p=topup_transfer"><span class="list-icon">&nbsp;</span>Topup Transfer</a></li>
                    <li><a href="../admin/?p=list_topup"><span class="list-icon">&nbsp;</span>Topup Transfer List</a></li>
                    <li><a href="../admin/?p=salary"><span class="list-icon">&nbsp;</span>Staff Salary</a></li>
                    <li><a href="../admin/?p=list_salary"><span class="list-icon">&nbsp;</span>Staff Salary List</a></li>
				</ul>
				</li>
                <li><a href="#" target="_blank"><span class="nav_icon money_2"></span>Report</span><span class="up_down_arrow">&nbsp;</span></a>
				<ul class="acitem">
					<li><a href="../admin/?p=kategori_purchase"><span class="list-icon">&nbsp;</span>Purchase Report</a></li>
					<li><a href="../admin/?p=category_daily_report"><span class="list-icon">&nbsp;</span>Daily Report</a></li>
   					<li><a href="../admin/?p=category_daily_reporttest"><span class="list-icon">&nbsp;</span>Cash Book report</a></li>
				</ul>
			</ul>
		</div>
	</div>
		...
		<div class="header_right">			
			<div id="user_nav">
				<ul>
					...
					<li class="user_info"><span class="user_name">Manager</span><span><a href="#">Profile</a> &#124; <? echo $_SESSION['staff_name']; ?> &#124;<a href=""> Time    </a><a href="" class=""><?php echo $time; ?> &#124; <?php echo $date; ?></a></span></li>
