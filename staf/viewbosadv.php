...
<body> 
    <div id="content">
<h3><span class="style1">VIEW BOS ADVANCE</span></h3>
                <form action="?p=edit_bosadv" method="post" class="form_container left_label">
                  <ul>
                    <li>
                      <div class="form_grid_12">
                        <label class="field_title">ID BOS ADVANCE</label>
                        <label class="description" for="element_1"><span class="style18">&nbsp;&nbsp; BA0
                    ...
                    <li>
                      <div class="form_grid_12">
                        ...
                        <div class="form_input">
                         <input name="txtButir" type="text" disabled="disabled" value="<? echo number_format($record1["keluar"],2,".",","); ?>" style=" width:100px;" />
                        </div>
                      </div>
                    <li>
                      <div class="form_grid_12">
                  ...
                  <ul>
                    <li>
                      ...
                      <div class="form_grid_12">
                        <div class="form_input">
                        <a href='?p=edit_bosadv&idCash=<? echo base64_encode($record1["idCash"]); ?>'>
