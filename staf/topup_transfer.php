...
<h3><span class="style1">TOPUP TRANSFER</span></h3>
		<form action="process_topuptransfer.php" method="post" class="form_container left_label">	
                      							
<ul>
										<li>
										<div class="form_grid_12">
											<label class="field_title">ID TOPUP TRANSFER</label>
											<label class="description" for="element_1"><span class="style18">&nbsp;&nbsp; TT0
        <?
						
						$sqlpro = "SELECT * FROM t_topup ORDER BY idTopup";
				        $resultpro = mysql_query($sqlpro) or die ('Data Topup Transfer cannot be reach. ' . mysql_error());
	...
	<li>
										  <div class="form_grid_12">
                                            ...
                                            <div class="form_input">
                                              <input id="txtMasuk" name="txtMasuk" type="text" value="" maxlength="255" class="small"/>
