...
if(($record))
{
	...
	echo "<script>alert('The Cash Book record ID cannot same with the ID in the database!');</script> ";
}

else {

$query = "INSERT INTO t_cashbook (idCash, cawangan, butir, tarikh, masuk, keluar, oleh, date2) 
			VALUES ('$txtCashId', '$txtcawangan', '$txtButir', STR_TO_DATE('$dateCash','%m/%d/%Y'), '$txtMasuk','$txtKeluar', '$prepared', '$txtdate')";
