...
$result20 = mysql_query($query20) or die ('Data Bos Advance cannot be reached.' . mysql_error());
...
<h3><span class="style1">BOS ADVANCE</span></h3>
		<form action="process_bosadv.php" method="post" class="form_container left_label">	
...
<ul>
	...
	<li>
										  <div class="form_grid_12">
                                            ...
                                            <div class="form_input">
                                              <input id="txtMasuk" name="txtKeluar" type="text" value="" maxlength="255" class="small"/>
