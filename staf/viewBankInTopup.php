...
$result1 = mysql_query($query1) or die ('Data Topup Book cannot be reached.' . mysql_error());
...
<body> 
    <div id="content">
<h3><span class="style1">VIEW BANK IN TOPUP RECORD</span></h3>
                <form action="?p=edit_bankin_topup" method="post" class="form_container left_label">
                  <ul>
                    <li>
                    ...
                    <li>
                     ...
                     <li>
                      <div class="form_grid_12">
                        ...
                        <div class="form_input">
                         <input name="txtButir" type="text" disabled="disabled" value="<? echo $record1["noslip"]; ?>" style=" width:100px;" />
                        </div>
                      </div>
                    </li>
                    <li>
                    ...
                    <li>
                      <div class="form_grid_12">
                        ...
                        <div class="form_input">
                         <input name="txtButir" type="text" disabled="disabled" value="<? echo $record1["masa"]; ?>" style=" width:100px;" />
                        </div>
                      </div>
                    </li>
                  ...
                  <ul>
                    <li>
                      ...
                      <div class="form_grid_12">
                        <div class="form_input">
                        <a href='?p=edit_bankin_topup&idTopup=<? echo base64_encode($record1["idTopup"]); ?>'>
                          <button type="button" class="btn_small btn_blue"><span>Edit</span></button></a>
                                                <input type="hidden" name="idTopup" value="<? echo $record1["idTopup"]; ?>" />
                                                <a href='delete_topupbook.php?idTopup=<? echo $record1["idTopup"]; ?>' onClick="return confirm_del()">
