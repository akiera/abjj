...
$query = "INSERT INTO t_purchase (idPurchase, cawangan, pembekal, noInv, tarikh, amaun, oleh, date2) 
			VALUES ('$txtPurchaseId', '$txtcawangan', '$txtpembekal', '$txtInv', STR_TO_DATE('$dateInv','%m/%d/%Y'), '$txtAmaun', '$prepared', '$txtdate')";
