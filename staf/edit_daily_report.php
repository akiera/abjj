...
<h3><span class="style3">EDIT DAILY REPORT</span></h3>
<form action="save_edit_daily_report.php" method="post" class="form_container left_label">	
                      							
<ul>
										<li>
										<div class="form_grid_12">
										  <label class="field_title">ID DAILY REPORT</label>
											<label class="description" for="element_1"><span class="style18">&nbsp;&nbsp; DR0 <span class="style15"><? echo $record["idDailyReport"]; ?></span></span></label>
										</div>
										</li>
            <li>
                                          <div class="form_grid_12">
		...
		{	
            ...
            <li>
              <div class="form_grid_12">
                ...
                <div class="form_input">
                  <input name="purchase" type="text" value="<? echo $record["purchase"]; ?>" maxlength="255" class="small"/>
                </div>
              </div>
            </li>
            <li>
